...
Hi! I'm **Ali Jazbi**, a **React Developer** with a strong foundation in **modern front-end technologies**. Over the past two years, I’ve focused on building **clean**, **responsive**, and **interactive** user interfaces using **HTML**, **CSS**, and **JavaScript**.  

I now specialize in building scalable web applications with **React.js**, **Next.js**, and popular UI frameworks like **Tailwind CSS**, **MUI**, and **Ant Design**. I’m passionate about writing clean code, learning best practices, and continuously improving my skills.  
...
HTML, CSS, JavaScript (ES6+), DOM, Event Handling  

✅ **Frameworks & Libraries**  
React.js, Next.js, Tailwind CSS, Material UI, Ant Design, Bootstrap  
...
- Build full-featured front-end applications with modern tools  
- Collaborate with other developers on real-world projects  
- Grow into a skilled front-end specialist with backend knowledge  
...
<br>
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/ali-jazbi/ali-jazbi/output/github-contribution-grid-snake-dark.svg">
